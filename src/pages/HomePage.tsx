    ...
    <div className="animate-page-in">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="lg:order-2 lg:pl-2">
            <p className="text-xs font-mono text-[var(--color-accent)] uppercase tracking-widest mb-3">
              Structural Engineer & AI Builder
            </p>
            <h1 className="font-[var(--font-display)] text-5xl lg:text-[3.5rem] leading-[1.1] text-[var(--color-text)] mb-5">
              Charles Azam
            </h1>
      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
        <div className="flex items-baseline justify-between mb-8">
          <h2 className="font-[var(--font-display)] text-2xl text-[var(--color-text)]">Projects</h2>
          <Link
            to="/projects"
            className="text-sm text-[var(--color-text-muted)] hover:text-[var(--color-accent)] link-underline transition-colors"
          >
            View all
          </Link>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {featuredProjects.map((project) => (
            <a
              ...
              className="group block p-5 rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-secondary)] hover:border-[var(--color-accent)] hover:shadow-md transition-all"
            >
              ...
              <p className="text-sm text-[var(--color-text-muted)] leading-relaxed">{project.description}</p>
            </a>
          ))}
        </div>
      </section>
      ...
      <section className="mx-auto max-w-5xl px-6 py-12">
        <div className="flex items-baseline justify-between mb-8">
          <h2 className="font-[var(--font-display)] text-2xl text-[var(--color-text)]">Writing</h2>
          <Link
            to="/blog"
            className="text-sm text-[var(--color-text-muted)] hover:text-[var(--color-accent)] link-underline transition-colors"
          >
        ...
        <div className="space-y-0 divide-y divide-[var(--color-border)]">
          {recentPosts.map((post) => (
            ...
            >
              <span className="text-[var(--color-text)] group-hover:text-[var(--color-accent)] transition-colors font-medium">
                {post.title}
              </span>
              <span className="text-xs text-[var(--color-text-muted)] whitespace-nowrap font-mono shrink-0">
