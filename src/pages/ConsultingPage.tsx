export function ConsultingPage() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-12">
      <h1 className="text-3xl font-bold text-[var(--color-text)] mb-2">Consulting</h1>
      <p className="text-[var(--color-text-muted)] mb-10">
        Selective projects in AI and automation, particularly traditional industries modernizing technical workflows.
      </p>

      <section className="mb-10">
        <h2 className="text-xl font-semibold text-[var(--color-text)] mb-4">Experience</h2>
        <p className="mb-4">
          <span className="text-[var(--color-text)] font-medium">Jimmy Energy (CIO, 2022-2024)</span>
          <br />
        ...
        <p className="mb-4">
          <span className="text-[var(--color-text)] font-medium">Production focus:</span> Build live systems
      ...
      <section className="mb-10 border-t border-[var(--color-border)] pt-10">
        <h2 className="text-xl font-semibold text-[var(--color-text)] mb-4">Approach</h2>
        <p className="text-[var(--color-text)] font-medium mb-2">Understand the real problem</p>
      ...
      <section className="border-t border-[var(--color-border)] pt-10">
        <h2 className="text-xl font-semibold text-[var(--color-text)] mb-4">Availability</h2>
        <p className="mb-4">
